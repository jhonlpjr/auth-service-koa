...
import { HEXADECIMAL, MILISECONDS_IN_A_SECOND, ONE_HOUR } from "../../shared/constants/general.constants";
...
export class RefreshTokenUseCase {
  ...
  async execute(userId: string, refreshToken: string, aud?: string, scope?: string) {
    ...
    const newRefreshToken = crypto.randomBytes(64).toString(HEXADECIMAL);
